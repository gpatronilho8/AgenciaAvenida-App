  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 mb-5">
        ...
        <ClickableStatCard title="Saldo Total" value={`€${saldoTotal.toFixed(2)}`} icon={TrendingUp} color="blue" subtitle="Banco + Caixa" to="/financeiro" />
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-5 mb-8">
        ...
        <ClickableStatCard title="Despesas do Mês" value={`€${despesasMes.toFixed(2)}`} icon={CheckCircle} color="purple" to="/despesas" />
      </div>
