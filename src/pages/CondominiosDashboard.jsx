    ...
    <div>
      ...
      {selectedCondominioId === 'all' ? (
        <div className="grid grid-cols-1 sm:grid-cols-4 gap-5 mb-8">
          <StatCard title="Total de Condomínios" value={activeCondominios.length} icon={Building2} color="blue" to="/condominios/lista" />
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 mb-8">
          <StatCard title="Quotas Pendentes" value={quotasPendentes} icon={Clock} color="orange" to="/condominios/quotas" />
          <StatCard title="Despesas do Mês" value={`€${despesasMes.toFixed(2)}`} icon={CheckCircle} color="purple" to="/condominios/movimentos" />
        </div>
      )}
